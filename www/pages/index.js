...
export default () => (
  <Page title="Next.js - The React Framework">
    <SocialMeta
      ...
      description="Next.js is the React framework for production. The world’s leading companies have used Next.js to build cutting-edge applications, websites, and more"
    />
    <MediaQueryConsumer>
      {({ isMobile }) => (
